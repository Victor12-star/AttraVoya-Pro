...
export const LANGUAGE_REFERENCE = Object.freeze([
  {
    code: 'aa',
    name: 'Afar',
    nativeName: 'Qafar',
  ...
  },
  {
    ...
    nativeName: 'آذربایجان تۆرکجه‌سی (عربجه)',
    direction: 'rtl',
  },
  {
    code: 'az-Cyrl',
  ...
  },
  {
    code: 'kk-Arab',
    name: 'Kazakh (Arabic)',
    nativeName: 'قازاق ءتىلى (اراب جازۋى)',
    direction: 'rtl',
  },
  {
    code: 'kl',
