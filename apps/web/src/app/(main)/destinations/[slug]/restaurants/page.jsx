...
import { RestaurantsPage } from '../../../../../features/destinations/restaurants-page.jsx';
import { loadMessages } from '../../../../../i18n/messages.js';
import { getRequestLocale } from '../../../../../i18n/request-locale.js';

export default async function DestinationRestaurantsRoutePage({ params, searchParams }) {
