...
start = text.index('## Current phase\n')
end = text.index('## CI interpretation rule\n')

replacement = """## Completed integration checkpoints — continued
